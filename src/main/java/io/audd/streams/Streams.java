...
/** Sync streams namespace. Mirrors {@code audd-python/src/audd/streams.py:Streams}. */
public final class Streams {
    ...
    /**
     * Long-poll for events on a category. Returns an iterator that blocks
     * for up to {@code timeout} seconds per request.
     *
     ...
     * to true.</p>
     */
    public Iterator<JsonNode> longpoll(String category) {
        return longpoll(category, LongpollOptions.defaults());
    }

    public Iterator<JsonNode> longpoll(String category, LongpollOptions opts) {
        ...
        return new LongpollIterator(category, opts);
    }

    private final class LongpollIterator implements Iterator<JsonNode> {
        private final String category;
        private final int timeout;
        private Long currentSince;

        LongpollIterator(String category, LongpollOptions opts) {
