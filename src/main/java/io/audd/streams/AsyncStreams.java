...
public final class AsyncStreams {
     ...
     */
    public CompletableFuture<Void> setCallbackUrl(String url, List<String> returnMetadata, Map<String, String> extraParameters) {
